...
class UsersDataFetcher (private val fileRetrievalService: FileRetrievalService){
    ...
    fun addUsersFromCsv(@InputArgument fileId: Long, @InputArgument editionId: Long): List<Users> {
        ...
        // TODO: Change to findByUsosIdAndEdition after merge with groups autogenerated names
        val group = groupsRepository.findById(usosId).orElseThrow { IllegalArgumentException("Group not found") }
