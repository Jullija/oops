...
export type SubcategoryFormValues = z.infer<typeof ValidationSchema>;
...
type AddSubcategoryFormProps = {
  handleAddSubcategory: (values: SubcategoryFormValues) => void;
  createError?: string;
};

export const AddSubcategoryForm = ({
  handleAddSubcategory: handleAddLevel,
  createError,
  ...
  const formik = useFormik({
    ...
    validate: (values: SubcategoryFormValues) => {
      try {
    ...
    onSubmit: (values: SubcategoryFormValues) => {
      handleAddLevel(values);
    },
  });

  return (
    <div style={styles.container}>
      <div style={styles.title}>Add Subcategory</div>
